...
export const AGN_SOCIAL_MEDIA: SocialMediaItem[] = [
  {
    title: 'Seguinos en Twitter',
    icon: 'fab fa-twitter',
    url: 'https://twitter.com/agnargentina',
  },
  {
    title: 'Seguinos en Instagram',
    icon: 'fab fa-instagram',
    url: 'https://www.instagram.com/agnargentina',
  },
  {
    title: 'Seguinos en Facebook',
    icon: 'fab fa-facebook-f',
    url: 'https://www.facebook.com/ArchivoGeneraldelaNacionArgentina',
  },
